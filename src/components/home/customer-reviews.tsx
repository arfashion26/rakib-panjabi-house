 ...
 *
 * Social proof through authentic-looking customer testimonials
 */
  ...
  const reviews = [
    {
      ...
      location: "Dhaka",
      rating: 5,
      text: "The quality of the Panjabi exceeded my expectations. The fabric is premium, the stitching is impeccable, and the fit is perfect. I have already ordered three more pieces!",
      product: "Premium Cotton Panjabi",
      initials: "TA",
    },
    {
      name: "Rakibul Hasan",
      location: "Chittagong",
      rating: 5,
      text: "I ordered a Sherwani for my wedding and it was absolutely stunning. The attention to detail, the embroidery, the fabric — everything was top-notch. Highly recommended!",
    ...
    },
    {
      ...
      location: "Sylhet",
      rating: 5,
      text: "Excellent customer service and fast delivery. The blazer I ordered fits perfectly and the quality is comparable to international brands at a fraction of the price.",
