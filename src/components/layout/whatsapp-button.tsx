        ...
        <div className="relative max-w-[220px] animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="rounded-xl border border-border bg-background p-3 shadow-xl">
            <button
              ...
              className="absolute -right-2 -top-2 flex h-5 w-5 items-center justify-center rounded-full bg-muted text-muted-foreground hover:bg-red-500 hover:text-white"
              aria-label="Close"
            >
              <X className="h-3 w-3" />
            </button>
