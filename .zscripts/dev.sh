...
# Temporarily allow db:push to fail (waiting for user to reset Supabase password)
bun run db:push || echo "WARNING: db:push failed - continuing without database (user needs to reset Supabase password)"
