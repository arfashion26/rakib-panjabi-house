...
INSERT INTO settings (key, value, type, description) VALUES
  ...
  ('contact_email', 'info@alrakib.com', 'string', 'Customer support email'),
  ('contact_phone', '+880 1716-243949', 'string', 'Customer support phone'),
  ('whatsapp_number', '+880 1716-243949', 'string', 'WhatsApp business number'),
  ('address', 'Shop no- 78, Mukjoddha Super Market, 3rd Floor, Mirpur-1, Dhaka-1216', 'string', 'Store address'),
